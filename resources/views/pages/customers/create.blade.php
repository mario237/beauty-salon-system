...
@section('title', __('general.add_new_customer'))
        ...
        <div class="row m-1">
            <div class="col-12 ">
                ...
                <ul class="app-line-breadcrumbs mb-3">
                    ...
                    <li class="active">
                        <a href="{{ route('admin.customers.create') }}" class="f-s-14 f-w-500">{{ __('general.add_new_customer') }}</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card ">
                    ...
                    <div class="card-body p-0">
                        <form class="m-3 app-form" action="{{route('admin.customers.store')}}" method="post">
                            @csrf
                            ...
                            <div class="form-group my-4">
                                ...
                                <select class="select-example form-select select-basic" name="source">
                                    @foreach($sources as $source)
                                        <option
                                            value="{{ $source }}">{{ \Illuminate\Support\Str::headline($source) }}</option>
                                    @endforeach
                                </select>
                                @error('source')
                                <span class="text-danger">{{ $message }}</span>
